...
public class WorldParameters extends AnnotatedPropertied {
	...
	// disease parameters
	@EditableProperty(group = "Disease", description = "Chance of transmission in public", lower = "0", upper = "1", readOnly = false)
	public double transmissionProbMeetings;
	@EditableProperty(group = "Disease", description = "Chance of transmission at work", lower = "0", upper = "1", readOnly = false)
	public double transmissionProbWork;
	@EditableProperty(group = "Disease", description = "Chance of transmission at home", lower = "0", upper = "1", readOnly = false)
	public double transmissionProbHome;
	@EditableProperty(group = "Disease", description = "Guaranteed sick days", lower = "0", upper = "20", readOnly = false)
	public int guaranteedSickDays;
	@EditableProperty(group = "Disease", description = "Chance sick days", lower = "1", upper = "20", readOnly = false)
	public int rangeSickDays;
	@EditableProperty(group = "Disease", description = "Chance to skip work when sick", lower = "0", upper = "1", readOnly = false)
	public double probSkipWork;
	@EditableProperty(group = "Init", description = "Chance to start sick", lower = "0", upper = "1", readOnly = false)
	public double startSickProb;
	@EditableProperty(group = "Init", description = "Sick days at start", lower = "0", upper = "20", readOnly = false)
	public int startSickDays;
	@EditableProperty(group = "Disease", description = "Cured agents develop resistance", lower = "false", upper = "true", readOnly = false)
	public boolean haveResistance;
	@EditableProperty(group = "Disease", description = "Length of resistance", lower = "0", upper = "20", readOnly = false)
	public int resistanceLength;
	@EditableProperty(group = "Disease", description = "Agents have an exposed period", lower = "false", upper = "true", readOnly = false)
	public boolean haveExposed;
	@EditableProperty(group = "Disease", description = "Length of exposed period", lower = "0", upper = "20", readOnly = false)
	...
	public WorldParameters(String fileName) throws IllegalArgumentException, IllegalAccessException, ConfigurationException {
		...
		for (int i = 0; i < fields.length; i++) 
		{
			...
			//if (skipMod == 0 || fields[i].getName().equals("a")) {
	...
	protected void initializationWithDefaultValues() {
		...
		// social network visualization
		isFriendFamilyGraphVisible = true;
		...
		//disease
		transmissionProbMeetings=.05;
		transmissionProbWork=.05;		
		transmissionProbHome=.25;
		guaranteedSickDays=4;
		rangeSickDays=4;
		probSkipWork=.5; 
		startSickProb=.1;
		startSickDays=5;
		haveResistance=false;
		resistanceLength=5;
		haveExposed=false;
		exposedLength=3;
		symptomProb=.1;
