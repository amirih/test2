...
public class Person implements Steppable, java.io.Serializable {
	...
	public Person(WorldModel model, long id, Family family) {
		...
		if(model.random.nextDouble()<model.params.startSickProb){this.sickDays=model.params.startSickDays;}
	...
	public DailyPlan planForSpecificDay(int dayDifferenceFromToday) { 
		...
		if (this.financialSafetyNeed.isEmployed()
				...
				&& (this.getSickDays()==0||model.random.nextDouble()<model.params.probSkipWork||!this.symptoms)) 
		{
	...
	public int getResistDays(){
		return this.resistDays;
	}

	public void setResistDays(int days){
		this.resistDays=days;
	}

	public void newResistDay(){this.resistDays--;}
	...
	public void newSickDay(){this.sickDays--;}

	public int getExposedDays(){
		return this.exposedDays;
	}

	public void setExposedDays(int days){
		this.exposedDays=days;
	}

	public void newExposedDay(){this.exposedDays--;}
